...
const getPrize = async () => {
  const prizes = [
    {
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.40.jpeg',
			title: 'Michi Potter'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.35.jpeg',
			title: 'Michi Pirates'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.34.jpeg',
			title: 'Michi HipHop'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.34-1.jpeg',
			title: 'Michi police'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.33.jpeg',
			title: 'Michi Batman'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.32.jpeg',
			title: 'Michi El-Matadore'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.31.jpeg',
			title: 'Michi Doctor'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.30.jpeg',
			title: 'Michi Astronaut'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.21.jpeg',
			title: 'Michi Dragon Ballz'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.24.jpeg',
			title: 'Michi Naruto'
		},
		{
			image: 'https://michieth.xyz/wp-content/uploads/2024/05/photo_2024-05-12-13.25.20.jpeg',
			title: 'Macptain Michi'
		},
  ];
...
const init = async () => {
  ...
  $machine.querySelector(".title").innerHTML = [...TITLE]
    .map((e) => `<span>${e}</span>`)
    .join("");
...
function handleBtnDownload() {
  btnDownload.classList.remove("hidden");
  const gameLayer = document.querySelector(".game-layer");

  document.addEventListener("click", (event) => {
    if (!btnDownload.classList.contains("hidden")) {
      ...
      if (
        ...
        const prizeUrl = prize.image;
        const prizeName = prize.image.split("/").pop();
  ...
  gameLayer.addEventListener("mousemove", (event) => {
    if (!btnDownload.classList.contains("hidden")) {
      const rect = btnDownload.getBoundingClientRect();
      const x = event.clientX;
      const y = event.clientY;
